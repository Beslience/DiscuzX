<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('tool_index');?><?php include template('common/header'); ?><style type="text/css">
.wp {
width: auto;
}
</style>
<link rel="stylesheet" href="static/css/tools.css" />
    <div class="banner_container">
    	<ul id="slides">
    		<li style="background:url(static/image/tools/1.jpg) no-repeat 50% 0px; z-index: 900px;"></li>
    		<li style="background:url(static/image/tools/201602221510015175.jpg) no-repeat 50% 0px; z-index: 900px;"></li>
    	</ul>
    </div>
    ...
    <div class="tools">
    	<div class="tools_container">
    		<div class="tools_left">
    			...
    			<a class="upload" href="tool.php?mod=index&amp;action=upload">我要上传</a>
    		</div>
    		<div class="tools_right">
    <?php if(is_array($tool_list)) foreach($tool_list as $val) { ?>    			<div class="tools_classify" >
    				<a class="tools_img" href="javascript:;" target="_blank">
    					<img src="data/attachment/tool/tool_pic/<?php echo $val['tool_pic'];?>">
    				</a>
    				<div class="tools_info">
    					<a href="javascript:;" target="_blank"><?php echo $val['tool_name'];?></a>
    					<p><?php echo $val['tool_desc'];?></p>
    				</div>
    				<div class="tools_fields">
    					<i class="fa fa-indent indent"></i>
    					<span><?php echo $val['tool_tag'];?></span>
    				</div>
    				<div class="tools_stat">
    					<i class="fa fa-eye eye"></i>
    					<span class="number"><?php echo $val['tool_viewnum'];?></span>
    					<div class="tools_author" title="提供者">
    						<i class="fa fa-user user"></i>
    					</div>
    					<div class="author_name"><?php echo $val['tool_user'];?></div>
    				</div>
    			</div>
    			<?php } ?>
               ...
               <!--  <div class="tools_right"><img src="static/image/serch-null.png" width="340" height="400" alt="" style=" display:block;margin:3rem auto 4rem"/></div>
               	    	</div> -->
    </div>
