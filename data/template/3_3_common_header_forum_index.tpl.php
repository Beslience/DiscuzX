...
0
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/PHPchina/common/header_common.htm', 1532766066, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/PHPchina', 'common/header_forum_index')
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/default/common/header_qmenu.htm', 1532766066, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/PHPchina', 'common/header_forum_index')
;?>
<!--/**
 * Created by PhpStorm.
 * User: ADKi
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> Powered by PHPChina</title>
<?php echo $_G['setting']['seohead'];?>

<meta name="keywords" content="<?php if(!empty($metakeywords)) { echo dhtmlspecialchars($metakeywords); } ?>" />
<meta name="description" content="<?php if(!empty($metadescription)) { echo dhtmlspecialchars($metadescription); ?> <?php } if(empty($nobbname)) { ?>,<?php echo $_G['setting']['bbname'];?><?php } ?>" />
<meta name="generator" content="PHPChina <?php echo $_G['setting']['version'];?>" />
...
<div class="top_left"><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?>
</div>
                <!--引入登陆注册模板-->
...
<!--导航-->
<div class="nav-main">
<div class="nav-main-left"><?php $mnid = getcurrentnav();?><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?>
</div>
<div class="nav-main-right"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="special" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
</div>
</div>
