...
0
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/PHPchina/common/header_common.htm', 1532785951, '3', './data/template/3_3_common_header_member_logging.tpl.php', './template/PHPchina', 'common/header_member_logging')
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/default/common/header_qmenu.htm', 1532785951, '3', './data/template/3_3_common_header_member_logging.tpl.php', './template/PHPchina', 'common/header_member_logging')
;?>
<!--/**
 * Created by PhpStorm.
 * User: ADKi
