...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1532785957, '3', './data/template/3_3_member_login.tpl.php', './template/PHPchina', 'member/login')
