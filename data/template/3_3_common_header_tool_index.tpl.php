...
0
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/PHPchina/common/header_common.htm', 1532769426, '3', './data/template/3_3_common_header_tool_index.tpl.php', './template/PHPchina', 'common/header_tool_index')
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/default/common/header_qmenu.htm', 1532769426, '3', './data/template/3_3_common_header_tool_index.tpl.php', './template/PHPchina', 'common/header_tool_index')
;?>
<!--/**
 * Created by PhpStorm.
 * User: ADKi
