...
0
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/PHPchina/common/header_common.htm', 1532768530, '3', './data/template/3_3_common_header_portal_portalcp.tpl.php', './template/PHPchina', 'common/header_portal_portalcp')
|| checktplrefresh('./template/PHPchina/common/header.htm', './template/default/common/header_qmenu.htm', 1532768530, '3', './data/template/3_3_common_header_portal_portalcp.tpl.php', './template/PHPchina', 'common/header_portal_portalcp')
;?>
<!--/**
 * Created by PhpStorm.
 * User: ADKi
